...
// Wire this to DetectionFilter::on_intent().
...
public:
    struct Config {
        ...
        // Parallel to object_list: COCO class index (0-79) for each word.
        // If shorter than object_list the remainder defaults to 0.
        // Example: object_list = {"cat", "dog"}
        //          object_ids  = {15,    16}
        std::vector<uint8_t>     object_ids;

        // Fired for every confirmed detection with word + object_id + is_final.
