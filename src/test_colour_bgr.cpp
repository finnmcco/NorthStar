/*
    test_colour_bgr.cpp  —  colour test: sends BGR directly to Hailo
    ══════════════════════════════════════════════════════════════════
    Identical to sim_session but camera frames are sent to Hailo as-is
    (BGR, no conversion).  Compare object summary against test_colour_rgb
    to determine which colour order the model expects.

    Usage:  ./test_colour_bgr [duration_seconds]   default: 5
*/
...
int main(int argc, char** argv)
{
    ...
    std::cout << "══════════════════════════════════════════\n"
              << "  COLOUR TEST — sending BGR to Hailo\n"
    ...
    while (g_running && Clock::now() < deadline) {
        ...
        // No colour conversion — send BGR directly.
