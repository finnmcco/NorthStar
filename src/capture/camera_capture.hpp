...
public:
    ...
    /*
        ...
        camera_id: value stamped onto every FramePacket::camera_id (0 = left/cam0,
                   1 = right/cam1).  Default 0 for single-camera builds.
    */
...
private:
    ...
    BufferPool& pool_;
    int fps_ = 30;
    uint8_t camera_id_ = 0;  // stamped onto every FramePacket::camera_id
